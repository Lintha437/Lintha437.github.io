...
function _applyExtValues(extension, event, names, map) {
    ...
    function TelemetryContext(coreConfig, propertiesConfig, core) {
        dynamicProto(TelemetryContext, this, function(_self) {
            ...
            _self.applyWebContext = function(event) {
                var _a;
                var web = _self.web;
                var evtWeb = _applyExtValues(3 /* eExtensions.WebExt */ , event, WebExtensionKeys, (_a = {},
                    ...
                    _a));
                evtWeb[WebExtensionKeys[4 /* eWebExtensionKeys.userConsent */ ]] = web.getUserConsent();
            };
            ...
            _self.applySdkContext = function(event) {
                ...
                var evtSdk = _applyExtValues(6 /* eExtensions.SdkExt */ , event, SDKExtKeys, (_a = {},
                    ...
                    _a));
                evtSdk[SDKExtKeys[1 /* eSDKExtKeys.seq */ ]] = _sdk.getSequenceId();
                evtSdk[SDKExtKeys[3 /* eSDKExtKeys.epoch */ ]] = _sdk.epoch;
            };
            ...
            _self.applyUtcContext = function(event) {
                var evtUtc = event.ext[Extensions[8 /* eExtensions.UtcExt */ ]];
                evtUtc[UtcExtKeys[0 /* eUtcExtKeys.popSample */ ]] = _utc.popSample;
                if (_utc.eventFlags > 0) {
                    evtUtc[UtcExtKeys[1 /* eUtcExtKeys.eventFlags */ ]] = _utc.eventFlags;
                }
            };
            _self.applyLocContext = function(event) {
                event.ext[Extensions[9 /* eExtensions.LocExt */ ]][LocExtKeys.tz] = _self.loc.tz;
            };
            _self.applySessionContext = function(event) {
                event.ext[Extensions[4 /* eExtensions.AppExt */ ]][SessionExtKeys[0 /* eSessionExtKeys.sessionId */ ]] = _getSessionId();
            };
            ...
            _self.applyDistributedTraceContext = function(event) {
                ...
                if (distributedTrace) {
                    ...
                    _applyExtValues(11 /* eExtensions.DtExt */ , event, DistributedTraceExtKeys, traceFields);
                }
            };
